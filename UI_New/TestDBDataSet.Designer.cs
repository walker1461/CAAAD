...
namespace UI_New {
    ...
    public partial class TestDBDataSet : global::System.Data.DataSet {
        ...
        public partial class table1DataTable : global::System.Data.TypedTableBase<table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public table1Row Addtable1Row(int ID, string FirstName, string LastName, string Address) {
...
namespace UI_New.TestDBDataSetTableAdapters {
    ...
    public partial class table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[table1] WHERE (([ID] = @Original_ID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[table1] ([ID], [FirstName], [LastName], [Address]) VALUES (@ID" +
                ", @FirstName, @LastName, @Address);\r\nSELECT ID, FirstName, LastName, Address FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[table1] SET [ID] = @ID, [FirstName] = @FirstName, [LastName] = @LastName, [Address] = @Address WHERE (([ID] = @Original_ID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT ID, FirstName, LastName, Address FROM table1 WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::UI_New.Properties.Settings.Default.TestDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, Address FROM dbo.table1";
        ...
        public virtual int Fill(TestDBDataSet.table1DataTable dataTable) {
        ...
        public virtual TestDBDataSet.table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDBDataSet.table1DataTable dataTable = new TestDBDataSet.table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDBDataSet.table1DataTable dataTable) {
        ...
        public virtual int Update(int ID, string FirstName, string LastName, string Address, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Address) {
        ...
        public virtual int Update(string FirstName, string LastName, string Address, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Address) {
            return this.Update(Original_ID, FirstName, LastName, Address, Original_ID, Original_FirstName, Original_LastName, Original_Address);
        }
    }
